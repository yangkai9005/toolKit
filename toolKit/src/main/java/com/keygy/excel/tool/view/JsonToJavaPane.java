...
public class JsonToJavaPane extends JPanel {
	 ...
	 * Create the panel.
	 */
	public JsonToJavaPane() {
		setBackground(Color.WHITE);
		setLayout(null);
		fileChooser.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
		
		JLabel modeNotice = new JLabel("Json 转 Java");
		modeNotice.setForeground(new Color(60, 179, 113));
		modeNotice.setFont(new Font("微软雅黑", Font.BOLD, 16));
		modeNotice.setBounds(352, 0, 98, 22);
		add(modeNotice);
		
		JLabel modeFileLable = new JLabel("Json文件路径:");
		...
		JLabel lblXml = new JLabel("Java文件路径:");
