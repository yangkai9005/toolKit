...
public class XmlToJavaPane extends JPanel {
	 ...
	 * Create the panel.
	 */
	public XmlToJavaPane() {
		setBackground(Color.WHITE);
		setLayout(null);
		fileChooser.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
		
		JLabel modeNotice = new JLabel("Xml 转 java");
		modeNotice.setForeground(new Color(60, 179, 113));
		modeNotice.setFont(new Font("微软雅黑", Font.BOLD, 16));
		modeNotice.setBounds(357, 0, 93, 22);
		add(modeNotice);
		
		JLabel modeFileLable = new JLabel("Xml文件路径:");
